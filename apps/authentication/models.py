...
class Users(db.Model, UserMixin):
    ...
    telegram user id = db.Column(db.Text, nullable=True)
    name = db.Column(db.Text, nullable=True)
    phone number = db.Column(db.Text, nullable=True)
    registered since = db.Column(db.DateTime, default=db.func.current_timestamp())
